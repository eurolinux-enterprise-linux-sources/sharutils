 ...
 *  
 *  It has been AutoGen-ed  January  6, 2013 at 05:54:53 PM by AutoGen 5.17.1
...
#line 51 "libopts/autoopts.c"
  puts(_("malloc of %d bytes failed\n"));
#line 52 "libopts/init.c"
  puts(_("AutoOpts function called without option descriptor\n"));
#line 85 "libopts/init.c"
  puts(_("\tThis exceeds the compiled library version:  "));
#line 83 "libopts/init.c"
  puts(_("Automated Options Processing Error!\n"
       "\t%s called AutoOpts function with structure version %d:%d:%d.\n"));
#line 64 "libopts/autoopts.c"
  puts(_("realloc of %d bytes at 0x%p failed\n"));
#line 87 "libopts/init.c"
  puts(_("\tThis is less than the minimum library version:  "));
#line 77 "libopts/autoopts.c"
  puts(_("strdup of %d byte string failed\n"));
#line 120 "libopts/version.c"
  puts(_("Automated Options version %s\n"
       "\tCopyright (C) 1999-2013 by Bruce Korb - all rights reserved\n"));
#line 585 "libopts/find.c"
  puts(_("AutoOpts lib error: defaulted to option with optional arg\n"));
#line 53 "libopts/alias.c"
  puts(_("(AutoOpts bug):  Aliasing option is out of range."));
#line 486 "libopts/enum.c"
  puts(_("all"));
#line 228 "libopts/enum.c"
  puts(_("%s error:  the keyword `%s' is ambiguous for %s\n"));
#line 104 "libopts/find.c"
  puts(_("  The following options match:\n"));
#line 286 "libopts/find.c"
  puts(_("%s: ambiguous option name: %s (matches %d options)\n"));
#line 107 "libopts/find.c"
  puts(_("  %s%s\n"));
#line 112 "libopts/find.c"
  puts(_("  %s%s\n"));
#line 157 "libopts/check.c"
  puts(_("%s: Command line arguments required\n"));
#line 78 "libopts/alias.c"
  puts(_("%d %s%s options allowed\n"));
#line 215 "libopts/autoopts.c"
  puts(_("%d %s%s options allowed\n"));
#line 872 "libopts/usage.c"
  puts(_("version, usage and configuration options:"));
#line 266 "libopts/makeshell.c"
  puts(_("Error %d (%s) from the pipe(2) syscall\n"));
#line 160 "libopts/version.c"
  puts(_("ERROR: version option argument '%c' invalid.  Use:\n"
       "\t'v' - version only\n"
       "\t'c' - version and copyright\n"
       "\t'n' - version and copyright notice\n"));
#line 56 "libopts/check.c"
  puts(_("ERROR:  %s option conflicts with the %s option\n"));
#line 108 "libopts/restore.c"
  puts(_("%s(optionSaveState): error: cannot allocate %d bytes\n"));
#line 593 "libopts/configfile.c"
  puts(_("auto-options"));
#line 592 "libopts/configfile.c"
  puts(_("program"));
#line 674 "libopts/configfile.c"
  puts(_("program"));
#line 679 "libopts/configfile.c"
  puts(_("program"));
#line 654 "libopts/usage.c"
  puts(_("\t\t\t\t- default option for unnamed options\n"));
#line 569 "libopts/usage.c"
  puts(_("\t\t\t\t- disabled as --%s\n"));
#line 210 "libopts/find.c"
  puts(_("%s: The ``%s'' option has been disabled"));
#line 417 "libopts/find.c"
  puts(_("%s: The ``%s'' option has been disabled"));
#line 839 "libopts/usage.c"
  puts(_("This option has been disabled"));
#line 73 "libopts/alias.c"
  puts(_("-equivalence"));
#line 210 "libopts/autoopts.c"
  puts(_("-equivalence"));
#line 75 "libopts/alias.c"
  puts(_("ERROR:  only "));
#line 212 "libopts/autoopts.c"
  puts(_("ERROR:  only "));
#line 916 "libopts/usage.c"
  puts(_(" - examining environment variables named %s_*\n"));
#line 1170 "libopts/configfile.c"
  puts(_("File error %d (%s) opening %s for loading options\n"));
#line 98 "libopts/text_mmap.c"
  puts(_("fs error %d (%s) reading file %s\n"));
#line 135 "libopts/file.c"
  puts(_("fopen-ing file"));
#line 74 "libopts/file.c"
  puts(_("stat-ing for directory"));
#line 86 "libopts/file.c"
  puts(_("stat-ing for regular file"));
#line 48 "libopts/file.c"
  puts(_("stat-ing for non-existant file"));
#line 108 "libopts/file.c"
  puts(_("open-ing file"));
#line 47 "libopts/file.c"
  puts(_("fs error %d (%s) on %s %s for option %s\n"));
#line 73 "libopts/file.c"
  puts(_("fs error %d (%s) on %s %s for option %s\n"));
#line 85 "libopts/file.c"
  puts(_("fs error %d (%s) on %s %s for option %s\n"));
#line 107 "libopts/file.c"
  puts(_("fs error %d (%s) on %s %s for option %s\n"));
#line 134 "libopts/file.c"
  puts(_("fs error %d (%s) on %s %s for option %s\n"));
#line 273 "libopts/usage.c"
  puts(_("Options are specified by doubled hyphens and their name or by a single\n"
       "hyphen and the flag character.\n"));
#line 272 "libopts/makeshell.c"
  puts(_("fs error %d (%s) on fork - cannot obtain %s usage\n"));
#line 802 "libopts/makeshell.c"
  puts(_("fs error %d (%s) on freopen\n"));
#line 880 "libopts/makeshell.c"
  puts(_("\n"
       "= = = = = = = =\n\n"
       "This incarnation of genshell will produce\n"
       "a shell script to parse the options for %s:\n\n"));
#line 456 "libopts/find.c"
  puts(_("%s: illegal option -- %c\n"));
#line 106 "libopts/reset.c"
  puts(_("%s: illegal option -- %c\n"));
#line 264 "libopts/find.c"
  puts(_("%s: illegal option -- %s\n"));
#line 758 "libopts/find.c"
  puts(_("%s: illegal option -- %s\n"));
#line 114 "libopts/reset.c"
  puts(_("%s: illegal option -- %s\n"));
#line 328 "libopts/find.c"
  puts(_("%s: unknown vendor extension option -- %s\n"));
#line 153 "libopts/enum.c"
  puts(_("  or an integer from %d through %d\n"));
#line 163 "libopts/enum.c"
  puts(_("  or an integer from %d through %d\n"));
#line 484 "libopts/usage.c"
  puts(_("AutoOpts ERROR:  invalid option descriptor for %s\n"));
#line 805 "libopts/usage.c"
  puts(_("AutoOpts ERROR:  invalid option descriptor for %s\n"));
#line 375 "libopts/find.c"
  puts(_("%s: invalid option name: %s\n"));
#line 160 "libopts/enum.c"
  puts(_("  or an integer mask with any of the lower %d bits set\n"));
#line 514 "libopts/find.c"
  puts(_("%s: option `%s' requires an argument\n"));
#line 162 "libopts/autoopts.c"
  puts(_("Equivalenced option '%s' was equivalenced to both\n"
       "\t'%s' and '%s'"));
#line 90 "libopts/check.c"
  puts(_("ERROR:  The %s option is required\n"));
#line 620 "libopts/find.c"
  puts(_("%s: option `%s' cannot have an argument\n"));
#line 147 "libopts/check.c"
  puts(_("%s: Command line arguments not allowed\n"));
#line 510 "libopts/save.c"
  puts(_("error %d (%s) creating %s\n"));
#line 275 "libopts/usage.c"
  puts(_("Options are specified by single or double hyphens and their name.\n"));
#line 228 "libopts/enum.c"
  puts(_("%s error:  `%s' does not match any %s keywords\n"));
#line 89 "libopts/reset.c"
  puts(_("The 'reset-option' option requires an argument\n"));
#line 1031 "libopts/usage.c"
  puts(_("   Arg Option-Name    Description\n"));
#line 967 "libopts/usage.c"
  puts(_("  Flg Arg Option-Name    Description\n"));
#line 1025 "libopts/usage.c"
  puts(_("  Flg Arg Option-Name    Description\n"));
#line 177 "libopts/save.c"
  puts(_("error %d (%s) stat-ing %s\n"));
#line 231 "libopts/save.c"
  puts(_("error %d (%s) stat-ing %s\n"));
#line 149 "libopts/restore.c"
  puts(_("%s(optionRestore): error: no saved option state\n"));
#line 491 "libopts/enum.c"
  puts(_("none"));
#line 252 "libopts/autoopts.c"
  puts(_("'%s' is not a command line option\n"));
#line 110 "libopts/time.c"
  puts(_("%s error:  `%s' is not a recognizable date/time\n"));
#line 126 "libopts/save.c"
  puts(_("'%s' not defined\n"));
#line 49 "libopts/time.c"
  puts(_("%s error:  `%s' is not a recognizable time duration\n"));
#line 89 "libopts/check.c"
  puts(_("ERROR:  The %s option must appear %d times\n"));
#line 1180 "libopts/configfile.c"
  puts(_("error:  cannot load options from non-regular file %s\n"));
#line 727 "libopts/makeshell.c"
  puts(_("error:  cannot load options from non-regular file %s\n"));
#line 250 "libopts/save.c"
  puts(_("error:  cannot load options from non-regular file %s\n"));
#line 149 "libopts/numeric.c"
  puts(_("%s error:  `%s' is not a recognizable number\n"));
#line 80 "libopts/alias.c"
  puts(_("one %s%s option allowed\n"));
#line 217 "libopts/autoopts.c"
  puts(_("one %s%s option allowed\n"));
#line 177 "libopts/makeshell.c"
  puts(_("Write failure to output file"));
#line 902 "libopts/makeshell.c"
  puts(_("Write failure to output file"));
#line 232 "libopts/usage.c"
  puts(_("Write failure to output file"));
#line 307 "libopts/usage.c"
  puts(_("Write failure to output file"));
#line 166 "libopts/version.c"
  puts(_("Write failure to output file"));
#line 701 "libopts/usage.c"
  puts(_(" - reading file %s"));
#line 302 "libopts/usage.c"
  puts(_("\n"
       "please send bug reports to:  %s\n"));
#line 104 "libopts/version.c"
  puts(_("\n"
       "please send bug reports to:  %s\n"));
#line 126 "libopts/version.c"
  puts(_("\n"
       "please send bug reports to:  %s\n"));
#line 673 "libopts/usage.c"
  puts(_("\n"
       "The following option preset mechanisms are supported:\n"));
#line 914 "libopts/usage.c"
  puts(_("\n"
       "The following option preset mechanisms are supported:\n"));
#line 54 "libopts/numeric.c"
  puts(_("%s error:  %s option value %ld is out of range.\n"));
#line 62 "libopts/numeric.c"
  puts(_("%sIt must lie in one of the ranges:\n"));
#line 62 "libopts/numeric.c"
  puts(_("%sIt must be in the range:\n"));
#line 283 "libopts/usage.c"
  puts(_("Operands and options may be intermixed.  They will be reordered.\n"));
#line 43 "libopts/check.c"
  puts(_("ERROR:  %s option requires the %s option\n"));
#line 401 "libopts/usage.c"
  puts(_("requires these options:\n"));
#line 1043 "libopts/usage.c"
  puts(_("   Arg Option-Name   Req?  Description\n"));
#line 1037 "libopts/usage.c"
  puts(_("  Flg Arg Option-Name   Req?  Description\n"));
#line 84 "libopts/reset.c"
  puts(_("The --reset-option has not been configured.\n"));
#line 117 "libopts/init.c"
  puts(_("-_^"));
#line 161 "libopts/enum.c"
  puts(_("or you may use a numeric representation.  Preceding these with a '!' will\n"
       "clear the bits, specifying 'none' will clear all bits, and 'all' will set them\n"
       "all.  Multiple entries may be passed as an option argument list.\n"));
#line 194 "libopts/enum.c"
  puts(_("%s error:  %s exceeds %s keyword count\n"));
#line 71 "libopts/enum.c"
  puts(_("The valid \"%s\" option keywords are:\n"));
#line 876 "libopts/usage.c"
  puts(_("The next option supports vendor supported extra options:"));
#line 512 "libopts/usage.c"
